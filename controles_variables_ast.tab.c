...
/* Line 189 of yacc.c  */
#line 90 "controles_variables_ast.tab.c"
...
/* Line 214 of yacc.c  */
#line 25 "controles_variables_ast.y"
...
/* Line 214 of yacc.c  */
#line 156 "controles_variables_ast.tab.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 168 "controles_variables_ast.tab.c"
...
{
       0,    55,    55,    68,    79,   119,   145,   171,   182,   189,
     215,   241,   242,   279,   284,   289,   296,   301,   306,   312,
     315
};
#endif
...
/* Line 1464 of yacc.c  */
#line 55 "controles_variables_ast.y"
...
/* Line 1464 of yacc.c  */
#line 68 "controles_variables_ast.y"
    {  if(error_compilacion>=1){
                    printf("\nHa habido %d error(es) de compilacion",error_compilacion);
                }else{
...
/* Line 1464 of yacc.c  */
#line 79 "controles_variables_ast.y"
    {
    printf("Asignacion\n");
...
/* Line 1464 of yacc.c  */
#line 119 "controles_variables_ast.y"
    {
...
/* Line 1464 of yacc.c  */
#line 145 "controles_variables_ast.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
            (yyval.st).a = new_node('-', (yyvsp[(1) - (3)].st).a,(yyvsp[(3) - (3)].st).a);
            (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 171 "controles_variables_ast.y"
    {
...
/* Line 1464 of yacc.c  */
#line 182 "controles_variables_ast.y"
...
/* Line 1464 of yacc.c  */
#line 189 "controles_variables_ast.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
            (yyval.st).a = new_node('*', (yyvsp[(1) - (3)].st).a,(yyvsp[(3) - (3)].st).a);
            (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 215 "controles_variables_ast.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
            (yyval.st).a = new_node('/', (yyvsp[(1) - (3)].st).a,(yyvsp[(3) - (3)].st).a); 
            (yyval.st).tipo="real";
...
/* Line 1464 of yacc.c  */
#line 241 "controles_variables_ast.y"
    {(yyval.st) = (yyvsp[(1) - (1)].st);;}
    break;
...
/* Line 1464 of yacc.c  */
#line 242 "controles_variables_ast.y"
    {
        ...
        if(i == -1){
            ...
            if(table[i].tipo=="entero"){
                ...
                (yyval.st).a = new_leaf_num(table[i].entero);    
            }
                ...
                //Crear nodo hoja con números
                (yyval.st).a = new_leaf_num(table[i].real);        
            }
                ...
                (yyval.st).a = new_leaf_text(table[i].texto);                
            }
...
/* Line 1464 of yacc.c  */
#line 279 "controles_variables_ast.y"
    {
...
/* Line 1464 of yacc.c  */
#line 284 "controles_variables_ast.y"
    {
            //$$.entero = $2;
...
/* Line 1464 of yacc.c  */
#line 289 "controles_variables_ast.y"
    {
            //$$.entero = -$2;
            (yyval.st).a = new_leaf_num(-(yyvsp[(2) - (2)].intVal));
              (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 301 "controles_variables_ast.y"
    {
            //$$.real = $2;
...
/* Line 1464 of yacc.c  */
#line 306 "controles_variables_ast.y"
    {
                //$$.real = -$2;
                (yyval.st).a = new_leaf_num(-(yyvsp[(2) - (2)].floatVal));
                  (yyval.st).tipo="real";
...
/* Line 1464 of yacc.c  */
#line 312 "controles_variables_ast.y"
...
/* Line 1464 of yacc.c  */
#line 315 "controles_variables_ast.y"
...
/* Line 1464 of yacc.c  */
#line 1743 "controles_variables_ast.tab.c"
      default: break;
    }
...
/* Line 1684 of yacc.c  */
#line 320 "controles_variables_ast.y"
