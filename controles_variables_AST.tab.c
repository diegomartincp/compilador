...
/* Line 189 of yacc.c  */
#line 6 "controles_variables_AST.y"
...
/* Line 189 of yacc.c  */
#line 89 "controles_variables_AST.tab.c"
...
/* Line 214 of yacc.c  */
#line 24 "controles_variables_AST.y"
  ...
  struct nodo_ast { // son sstruct porque son punteros a otras estructuras
    struct nodo_ast* izq;
    struct nodo_ast* der;
    struct atributos* st;
    }ast;
...
/* Line 214 of yacc.c  */
#line 161 "controles_variables_AST.tab.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 173 "controles_variables_AST.tab.c"
...
{
       0,    61,    61,    71,    82,   122,   148,   174,   185,   192,
     218,   244,   254,   264,   265,   293,   296,   299,   304,   307,
     310,   314,   317
};
#endif
...
/* Line 1464 of yacc.c  */
#line 61 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 71 "controles_variables_AST.y"
    {  if(error_compilacion>=1){
                    printf("\nHa habido %d error(es) de compilacion",error_compilacion);
                }else{
                    printf("%d",error_compilacion);
...
/* Line 1464 of yacc.c  */
#line 82 "controles_variables_AST.y"
    {
    printf("Asignacion\n");
...
/* Line 1464 of yacc.c  */
#line 122 "controles_variables_AST.y"
    {
...
/* Line 1464 of yacc.c  */
#line 148 "controles_variables_AST.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
        (yyval.st).entero = (yyvsp[(1) - (3)].st).entero - (yyvsp[(3) - (3)].st).entero;
        (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 174 "controles_variables_AST.y"
    {
...
/* Line 1464 of yacc.c  */
#line 185 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 192 "controles_variables_AST.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
            (yyval.st).entero = (yyvsp[(1) - (3)].st).entero * (yyvsp[(3) - (3)].st).entero;
            (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 218 "controles_variables_AST.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
...
/* Line 1464 of yacc.c  */
#line 244 "controles_variables_AST.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
            (yyval.st).entero = (yyvsp[(1) - (3)].st).entero % (yyvsp[(3) - (3)].st).entero;
            (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 254 "controles_variables_AST.y"
    {
        if (strcmp((yyvsp[(1) - (3)].st).tipo, "entero")==0 && strcmp((yyvsp[(3) - (3)].st).tipo, "entero")==0) { //Si ambos son enteros
...
/* Line 1464 of yacc.c  */
#line 264 "controles_variables_AST.y"
    {(yyval.st) = (yyvsp[(1) - (1)].st);;}
    break;
...
/* Line 1464 of yacc.c  */
#line 265 "controles_variables_AST.y"
    {
...
/* Line 1464 of yacc.c  */
#line 293 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 296 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 299 "controles_variables_AST.y"
    {(yyval.st).entero = -(yyvsp[(2) - (2)].intVal);
              (yyval.st).tipo="entero";
...
/* Line 1464 of yacc.c  */
#line 304 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 307 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 310 "controles_variables_AST.y"
    {(yyval.st).real = -(yyvsp[(2) - (2)].floatVal);
                  (yyval.st).tipo="real";
...
/* Line 1464 of yacc.c  */
#line 314 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 317 "controles_variables_AST.y"
...
/* Line 1464 of yacc.c  */
#line 1763 "controles_variables_AST.tab.c"
      default: break;
    }
...
/* Line 1684 of yacc.c  */
#line 322 "controles_variables_AST.y"
