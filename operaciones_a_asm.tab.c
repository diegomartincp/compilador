...
/* Line 189 of yacc.c  */
#line 90 "operaciones_a_asm.tab.c"
...
/* Line 214 of yacc.c  */
#line 156 "operaciones_a_asm.tab.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 168 "operaciones_a_asm.tab.c"
...
#line 245 "operaciones_a_asm.y"
    {
        ...
        if(i == -1){
            ...
            if(table[i].tipo=="entero"){
                ...
                (yyval.st).a = new_leaf_num(table[i].entero,"entero");    
            }
                ...
                //Crear nodo hoja con números
                (yyval.st).a = new_leaf_num(table[i].real,"real");        
            }
                ...
                (yyval.st).a = new_leaf_text(table[i].texto,"string");                
            }
...
/* Line 1464 of yacc.c  */
#line 1745 "operaciones_a_asm.tab.c"
      default: break;
    }
